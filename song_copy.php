...
echo "<table width=962 border ='1' bordercolor ='#000000'><tr>";
		...
		echo "Do you want to put $title in the song list?";
		
		echo "</h4></th><th><h4 class='t'>";
		echo "<a href='confirm_copy.php?title=";
		...
		echo rawurlencode($title);
		echo "&letter=$letter&dbname=$dbname&iter=$iter&inext=$inextt&orient=$orient'>No</a>";
