...
echo "<table width=962 border ='1' bordercolor ='#000000'><tr>";
		...
		echo "Are you sure you want do delete all the files in the $letter directory?";
		
		echo "</h4></th><th><h4 class='t'>";
		echo "<a href='confirm_delete_all.php?&letter=$lette&dbname=$dbname&iter=$iter&inext=$inext&orient=$orient'>Yes</a>";
		
		echo "</h4></th><th><h4 class='t'>";
		echo "<a href='songs.php?title=";
		echo rawurlencode($title);
		echo "&letter=$lette&dbname=$dbname&iter=$iter&inext=$inext&orient=$orient'>No</a>";
