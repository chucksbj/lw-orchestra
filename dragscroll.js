...
(DragScroll=/*2843295374657068656E204368616C6D657273*/
{
 ...
 getMousePosition:function(e)
 {
  ...
  {
   case 3 : this.x = 0;
            this.y = (Math.max(document.documentElement.scrollTop, document.body.scrollTop) + this.e.clientY)/1.3;
            break;
                 
   case 2 : this.x = 0;
            this.y = (document.body.scrollTop + this.e.clientY)/1.3;
            break;
            
   case 1 : this.x = 0; this.y = (this.e.pageY)/1.3; break;
