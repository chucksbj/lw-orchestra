...
pwlib.tools.insertimg = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/';
  }
  ...
  this.preActivate = function () {
    ...
    if (!_self.url || _self.url.toLowerCase() === 'https://music.livingwrd.org/images/') {
      return false;
    }
...
pwlib.tools.inserthand = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/hand.png';
  }
...
pwlib.tools.insertsalute = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/salute.png';
  }
...
pwlib.tools.insertrepeat = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/repeat.png';
  }
...
pwlib.tools.insertsharp = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/sharp.png';
  }
...
pwlib.tools.insertneutral = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/neutral.png';
  }
...
pwlib.tools.insertflat = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/flat.png';
  }
...
pwlib.tools.insertrepop = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/repop.png';
  }
...
pwlib.tools.insertrepcl = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/repcl.png';
  }
...
pwlib.tools.insertfermatta = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/fermatta.png';
  }
...
pwlib.tools.insertwhole = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/whole.png';
  }
...
pwlib.tools.inserthalf = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/half.png';
  }
...
pwlib.tools.inserthalfhead = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/halfhead.png';
  }
...
pwlib.tools.insertnotehead = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/notehead.png';
  }
...
pwlib.tools.insertquarter = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/quarter.png';
  }
...
pwlib.tools.inserteighth = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/eighth.png';
  }
...
pwlib.tools.insertsixth = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/sixth.png';
  }
...
pwlib.tools.insertwrest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/wrest.png';
  }
...
pwlib.tools.inserthrest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/hrest.png';
  }
...
pwlib.tools.insertqrest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/qrest.png';
  }
...
pwlib.tools.inserterest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/erest.png';
  }
...
pwlib.tools.insertsrest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/srest.png';
  }
...
pwlib.tools.insertpiano = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/piano.png';
  }
...
pwlib.tools.insertmpiano = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/mpiano.png';
  }
...
pwlib.tools.insertmforte = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/mforte.png';
  }
...
pwlib.tools.insertforte = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/forte.png';
  }
...
pwlib.tools.inserta = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/a.png';
  }
...
pwlib.tools.insertb = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/b.png';
  }
...
pwlib.tools.insertc = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/c.png';
  }
...
pwlib.tools.insertd = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/d.png';
  }
...
pwlib.tools.inserte = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/e.png';
  }
...
pwlib.tools.insertf = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'https://music.livingwrd.org/images/f.png';
  }
