...
pwlib.tools.insertimg = function (app) {
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/';
  }
  ...
  this.preActivate = function () {
    ...
    if (!_self.url || _self.url.toLowerCase() === 'http://maint.livingwrd.org/Music/images/') {
      return false;
    }
...
/**
 * @class The "Insert hand" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.inserthand = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/hand.png';
  }
  ...
  function ev_imageLoaded () {
    ...
    gui.statusShow('inserthandLoaded');
  };
  ...
  this.mousedown = function (ev) {
    if (!imageLoaded) {
      alert(lang.errorInserthandNotLoaded);
      return false;
    }
    ...
    gui.statusShow('inserthandResize');
...
/**
 * @class The "Insert salute" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertsalute = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/salute.png';
  }
...
/**
 * @class The "Insert repeat" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertrepeat = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/repeat.png';
  }
...
/**
 * @class The "Insert sharp" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertsharp = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/sharp.png';
  }
...
/**
 * @class The "Insert neutral" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertneutral = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/neutral.png';
  }
...
/**
 * @class The "Insert flat" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertflat = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/flat.png';
  }
...
/**
 * @class The "Insert repop" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertrepop = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/repop.png';
  }
...
/**
 * @class The "Insert repeat closed" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertrepcl = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/repcl.png';
  }
...
/**
 * @class The "Insert repeat open" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertrepop = function (app) {
...
/**
 * @class The "Insert fermatta" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertfermatta = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/fermatta.png';
  }
...
/**
 * @class The "Insert whole note" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertwhole = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/whole.png';
  }
...
/**
 * @class The "Insert half note" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.inserthalf = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/half.png';
  }
...
/**
 * @class The "Insert half note head" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.inserthalfhead = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/halfhead.png';
  }
...
/**
 * @class The "Insert note head" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertnotehead = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/notehead.png';
  }
...
/**
 * @class The "Insert quarter note" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertquarter = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/quarter.png';
  }
...
/**
 * @class The "Insert eighth note" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.inserteighth = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/eighth.png';
  }
...
/**
 * @class The "Insert sixteenth note" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertsixth = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/sixth.png';
  }
...
/**
 * @class The "Insert whole rest" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertwrest = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/wrest.png';
  }
...
/**
 * @class The "Insert half rest" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.inserthrest = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/hrest.png';
  }
...
/**
 * @class The "Insert quarter rest" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertqrest = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/qrest.png';
  }
...
/**
 * @class The "Insert eighth rest" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.inserterest = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/erest.png';
  }
...
/**
 * @class The "Insert sixteenth rest" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertsrest = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/srest.png';
  }
...
/**
 * @class The "Insert piano" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertpiano = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/piano.png';
  }
...
/**
 * @class The "Insert mezzo piano" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertmpiano = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/mpiano.png';
  }
...
/**
 * @class The "Insert mezzo forte" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertmforte = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/mforte.png';
  }
...
/**
 * @class The "Insert forte" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertforte = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/forte.png';
  }
...
/**
 * @class The "Insert A" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.inserta = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/a.png';
  }
...
/**
 * @class The "Insert B" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertb = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/b.png';
  }
...
/**
 * @class The "Insert C" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertc = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/c.png';
  }
...
/**
 * @class The "Insert D" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertd = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/d.png';
  }
...
/**
 * @class The "Insert E" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.inserte = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/e.png';
  }
...
/**
 * @class The "Insert F" tool.
 *
 * @param {PaintWeb} app Reference to the main paint application object.
 */
pwlib.tools.insertf = function (app) {
  var _self         = this,
      canvasImage   = app.image,
      clearInterval = app.win.clearInterval,
      config        = app.config,
   ...
   */
  if (!this.url) {
    this.url = 'http://maint.livingwrd.org/Music/images/f.png';
  }
