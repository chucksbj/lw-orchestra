...
var urlsuffix = location.pathname;
//var imageurl = fullurl.replace(urlsuffix, "");
...
pwlib.tools.insertimg = function (app) {
  ...
  this.preActivate = function () {
    ...
    if (!_self.url || _self.url.toLowerCase() === imageurl + "/images") {
      return false;
    }
...
pwlib.tools.inserthand = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/hand.png';
  }
...
pwlib.tools.insertsalute = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/salute.png';
  }
...
pwlib.tools.insertrepeat = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/repeat.png';
  }
...
pwlib.tools.insertsharp = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/sharp.png';
  }
...
pwlib.tools.insertneutral = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/neutral.png';
  }
...
pwlib.tools.insertflat = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/flat.png';
  }
...
pwlib.tools.insertrepop = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/repop.png';
  }
...
pwlib.tools.insertrepcl = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/repcl.png';
  }
...
pwlib.tools.insertfermatta = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/fermatta.png';
  }
...
pwlib.tools.insertwhole = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/whole.png';
  }
...
pwlib.tools.inserthalf = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/half.png';
  }
...
pwlib.tools.inserthalfhead = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/halfhead.png';
  }
...
pwlib.tools.insertnotehead = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/notehead.png';
  }
...
pwlib.tools.insertquarter = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/quarter.png';
  }
...
pwlib.tools.inserteighth = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/eighth.png';
  }
...
pwlib.tools.insertsixth = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/sixth.png';
  }
...
pwlib.tools.insertwrest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/wrest.png';
  }
...
pwlib.tools.inserthrest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/hrest.png';
  }
...
pwlib.tools.insertqrest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/qrest.png';
  }
...
pwlib.tools.inserterest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/erest.png';
  }
...
pwlib.tools.insertsrest = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/srest.png';
  }
...
pwlib.tools.insertpiano = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/piano.png';
  }
...
pwlib.tools.insertmpiano = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/mpiano.png';
  }
...
pwlib.tools.insertmforte = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/mforte.png';
  }
...
pwlib.tools.insertforte = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/forte.png';
  }
...
pwlib.tools.inserta = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/a.png';
  }
...
pwlib.tools.insertb = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/b.png';
  }
...
pwlib.tools.insertc = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/c.png';
  }
...
pwlib.tools.insertd = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/d.png';
  }
...
pwlib.tools.inserte = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/e.png';
  }
...
pwlib.tools.insertf = function (app) {
   ...
   */
  if (!this.url) {
    this.url = imageurl + '/images/f.png';
  }
